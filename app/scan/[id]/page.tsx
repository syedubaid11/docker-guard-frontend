...
export default function ScanDetail() {
  ...
  return (
    <div
      className="min-h-screen w-full bg-white tasa-orbiter-display text-black"
      style={gridBackground}
    >
      <header className="border-b border-gray-200 px-6 py-4 flex items-center justify-between bg-white/80 backdrop-blur-sm sticky top-0 z-10">
